...
CHANNEL = os.environ.get('CHANNEL', "newnetflixmovies_Premium")
...
botid = token.split(':')[0]
FLOOD = 500
LAZY_PIC = os.environ.get("LAZY_PIC", "https://te.legra.ph/file/46258597114f6a584afab.jpg")
	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      ...
                                      [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://t.me/Bamel_Backup/9')]
                                      ]))
        return
    if id:
        if old == True:
